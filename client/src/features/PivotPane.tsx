...
import { useStore, selectActiveTab, selectPivotBuckets, selectPivotPaneCollapsed } from '@/store/fieldsStore';
    ...
    if (isCollapsed) {
        return (
            <div className="h-full w-12 border-r bg-background flex flex-col items-center py-2">
                ...
                <div className="[writing-mode:vertical-lr] text-sm font-semibold">Pivot</div>
            </div>
        );
    }
